...
public:
	...
	virtual std::any visitReturnStmt(std::shared_ptr<Stmt::Return> stmt) = 0;
...
public:
	...
	Return(Token _keyword, std::shared_ptr<Expr> _value)
		: keyword(std::move(_keyword)), value(std::move(_value)) {}
